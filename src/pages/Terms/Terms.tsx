...
export default function Terms() {
  return (
    <div>
      <p>Welcome to IntheMiddle!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of IntheMiddle's Website, located at inthemiddle.app.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use IntheMiddle if you do not agree to
      ...
      <p>
        ...
        this website and compliant to the Company&rsquo;s terms and conditions.
        ...
        purpose of meeting the Client&rsquo;s needs in respect of provision of
        the Company&rsquo;s stated services, in accordance with and subject to,
        ...
        taken as interchangeable and therefore as referring to same. Cookies
      </p>

      <p>
        We employ the use of cookies. By accessing IntheMiddle, you agreed to
        use cookies in agreement with the IntheMiddle's Privacy Policy.
      </p>
      ...
      <p>
        ...
        also use cookies. License
      </p>

      <p>
        Unless otherwise stated, IntheMiddle and/or its licensors own the
        intellectual property rights for all material on IntheMiddle. All
        intellectual property rights are reserved. You may access this from
        InTheMiddle for your own personal use subjected to restrictions set in
      ...
      <p>
        {" "}
        Republish material from InTheMiddle Sell, rent or sub-license material
        from InTheMiddle Reproduce, duplicate or copy material from InTheMiddle
        Redistribute content from InTheMiddle
      </p>
      ...
      <p>
        ...
        InTheMiddle does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of InTheMiddle ,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, InTheMiddle shall not be
      ...
      <p>
        InTheMiddle reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant InTheMiddle a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media. Hyperlinking to our
        Content
      </p>
      ...
      <p>
        ...
        fits within the context of the linking party&rsquo;s site.
      </p>
      ...
      <p>
        ...
        the hyperlink compensates the absence of InTheMiddle; and (d) the link
      ...
      <p>
        ...
        e-mail to InTheMiddle. Please include your name, your organization name,
      ...
      <p>
        ...
        the linking party&rsquo;s site.
      </p>

      <p>
        No use of InTheMiddle's logo or other artwork will be allowed for
      ...
      <p>
        ...
        appearance of our Website. Content Liability
      </p>
      ...
      <p>
        ...
        any third party rights. Your Privacy
      </p>
      ...
      <p>
        ...
        these linking terms and conditions. Removal of links from our website
      </p>
